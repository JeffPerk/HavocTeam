...
havoc_briefing_admin = "ADMIN BRIEFING<br/><br/>";
...
// Insert custom text
havoc_briefing_admin = havoc_briefing_admin + "your text here";

player createDiaryRecord ["diary", ["Admin", havoc_briefing_admin]];