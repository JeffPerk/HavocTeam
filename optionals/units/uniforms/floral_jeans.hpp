...
class GVAR(Uniform_Floral_JP_BS_LP_BB): GVAR(Uniform_Base_Floral) {
    scope = 2;
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QGVAR(Unit_Floral_JP_BS_LP_BB);
    };
};
class GVAR(Uniform_Floral_JP_RS_LP_BB): GVAR(Uniform_Base_Floral) {
    scope = 2;
    author = "Trenchgun, Tyrone";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QGVAR(Unit_Floral_JP_RS_LP_BB);
    };
};
class GVAR(Uniform_Floral_JP_GS_LP_BB): GVAR(Uniform_Base_Floral) {
    scope = 2;
    author = "Trenchgun, Tyrone";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QGVAR(Unit_Floral_JP_GS_LP_BB);
    };
};
class GVAR(Uniform_Floral_JP_WS_LP_BB): GVAR(Uniform_Base_Floral) {
    scope = 2;
    author = "Trenchgun, Tyrone";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QGVAR(Unit_Floral_JP_WS_LP_BB);
    };
};
class GVAR(Uniform_Floral_JP_BYS_LP_BB): GVAR(Uniform_Base_Floral) {
    scope = 2;
    author = "Trenchgun, Tyrone";
    ...
    class ItemInfo: ItemInfo {
        uniformClass = QGVAR(Unit_Floral_JP_BYS_LP_BB);
    };
};
