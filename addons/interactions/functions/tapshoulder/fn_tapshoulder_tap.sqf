 ...
 * \z\havoc\addons\interactions\functions\tapshoulder\fn_tapshoulder_tap.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [player, unit1, 0] call HAVOC_interactions_fnc_tapshoulder_tap;
 * 
 */
...
if (missionNamespace getVariable ["havoc_interactions_tapshoulder_hint", true]) then {
