 ...
 * \Havoc_common\functions\common\fn_createLitterServer.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [player, "MedicalGarbage_01_FirstAidKit_F"] call Havoc_fnc_createLitterServer;
 * 
 */
...
[_unit, _className, _offset] spawn {
    ...
    if ([_unit] call Havoc_fnc_isInBuilding) then {
