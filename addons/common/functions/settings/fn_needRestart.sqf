 ...
 * \Havoc_common\functions\settings\fn_needRestart.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * ["Havoc_debug_enabled", 2] call Havoc_fnc_needRestart;
 * 
 */
...
switch (_restartID) do {
    ...
    // RESTART MISSION
    case 1: {
        [_setting, _restartID] remoteExec ["Havoc_fnc_needRestartLocal", 0];
    };
    ...
    case 3: {
        [_setting, _restartID] remoteExec ["Havoc_fnc_needRestartLocal", player];
    };
