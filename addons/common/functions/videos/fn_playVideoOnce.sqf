 ...
 * \Havoc_common\functions\videos\fn_playVideoOnce.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * ["intro.ogv"] call Havoc_fnc_playVideoOnce;
 * 
 */
...
private _return = [_filename, _videoID, _canSkip, _showSkip, _showTime] spawn {
    ...
    private _videoTag = format ["Havoc_Video_%1", _videoID];
    ...
    if ( (_canSkip) && (_showSkip) ) then {
        _script = [_showTime] spawn {
            ...
            private _skipMsg = format ["<t font='RobotoCondensed' color='#ffffff' shadow='2' size='1.6'>%1</t>", localize "STR_Havoc_Message_SkipVideo"];
    ...
    private _keyHandler = (findDisplay 46) displayAddEventHandler ["KeyDown", "_this call Havoc_fnc_videoKeyDown"];
