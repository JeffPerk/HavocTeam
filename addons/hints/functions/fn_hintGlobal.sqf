 ...
 * \z\havoc\addons\hints\functions\fn_hintGlobal.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [ format [hint_havoc_default, "Hello World"] ] call havoc_fnc_hintGlobal;
 * 
 */
...
[_text, _color, _sound, _delay, _position] remoteExecCall ["havoc_fnc_hint", 0];
