/*
Function: havoc_fnc_GetAvailableFactions
...

{
    ...
    private _sideVar = format ["HAVOC_AvailableFactions_%1", _side];
    ...
    if !(isNil _sideVar) then {
        ...
        _sideFactions = [nil, ["HAVOC_AI", format ["%1_Factions", _side]]] call YAINA_F_fnc_GetFunctions;
