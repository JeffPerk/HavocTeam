/*
Function: havoc_fnc_SetUnitSkill
...
if !(isNil "havoc_AI_AimingAccuracy") then {
    _skillv = [
        ...
        (HAVOC_AI_AimingSpeed + random 0.20),
        (HAVOC_AI_Commanding),
        (HAVOC_AI_Courage), 1,
        (HAVOC_AI_General),
        (HAVOC_AI_ReloadSpeed + random 0.50),
        (HAVOC_AI_SpotDistance + random 0.30),
        (HAVOC_AI_SpotTime + random 0.40)
    ];
};
