...
[_unit] spawn {
 ...
 {true},
    ...
    if (havoc_MEDICAL_SUPPLIES_UNPACK_SUCCESS) exitWith {
        ...
        [_unit, "kat_accuvac", 01, _order, _overflow] call havoc_fnc_addItem;
        [_unit, "kat_X_AED", 01, _order, _overflow] call havoc_fnc_addItem;
        [_unit, "kat_stethoscope", 01, _order, _overflow] call havoc_fnc_addItem;
        [_unit, "kat_Pulseoximeter", 01, _order, _overflow] call havoc_fnc_addItem;
        [_unit, "kat_IO_FAST", 06, _order, _overflow] call havoc_fnc_addItem;
        [_unit, "kat_IV_16", 06, _order, _overflow] call havoc_fnc_addItem;
        [_unit, "kat_TXA", 06, _order, _overflow] call havoc_fnc_addItem;
