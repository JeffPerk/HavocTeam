class RscNotepad {
    ...
    onLoad = "[""onLoad"",_this,""RscNotepad"",'HAVOCDisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onUnload = "[""onUnload"",_this,""RscNotepad"",'HAVOCDisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onMouseButtonDown = "\
