...
private _turnOnAction = [
    ...
    "",
    {
        ...
        [_object, _selection, true, _args] call HAVOC_fnc_turnOnScreen;
    },
    {
        params ["_target", "_player", "_params"];
        _params params ["_object", "_selection"];
...
private _turnOffAction = [
    ...
    "",
    {
        ...
        [_object, _selection, false, _args] call HAVOC_fnc_turnOnScreen;
    },
    {
        params ["_target", "_player", "_params"];
        _params params ["_object", "_selection"];
...
private _toggleVisualAction = [
    ...
    "",
    {
        ...
        [_object, _selection] call HAVOC_fnc_toggleVisualMode;
    },
    {
        params ["_target", "_player", "_params"];
        _params params ["_object", "_selection"];
