...
HAVOC_CC_currentScreenObject = _object;
HAVOC_CC_currentScreenSelection = _selection;
...
(_display displayCtrl 2400) ctrlSetEventHandler ["ButtonClick", "[] call HAVOC_fnc_viewHelmetCam"];
(_display displayCtrl 2401) ctrlSetEventHandler ["ButtonClick", "[0] call HAVOC_fnc_viewDroneCam"];
(_display displayCtrl 2402) ctrlSetEventHandler ["ButtonClick", "[] call HAVOC_fnc_viewSatImage"];
(_display displayCtrl 2403) ctrlSetEventHandler ["ButtonClick", "[1] call HAVOC_fnc_viewDroneCam"];
