...
private _object = HAVOC_CC_currentScreenObject;
private _selection = HAVOC_CC_currentScreenSelection;
...
// set the mode
_object setVariable [format ["HAVOC_CC_screen_%1_mode", _selection], "SAT", true];
...
[_object, _selection, _renderTarget, _data] remoteExec ["HAVOC_fnc_viewSatGlobal", 0, _screen_JIP_id];
...
_object setVariable [format ["HAVOC_CC_screen_%1_visionMode", _selection], 0, true];
