...
class havoc_booboo: ACE_ItemCore {
    ...
    picture="\z\havoc\addons\media\images\icon\booboo_ca.paa";
    class ItemInfo: CBA_MiscItem_ItemInfo {
        mass=0.01;
    };
};
class havoc_cascard: havoc_booboo {
    scope = 2;
    displayName="TACMED Casualty Cards";
    picture="\z\havoc\addons\media\images\icon\cascard_ca.paa";
    descriptionShort="";
    descriptionUse="";
};
class havoc_nargloves: havoc_booboo {
    scope = 2;
...
class havoc_shears: havoc_booboo {
    scope = 2;
    displayName="Trauma Shears";
    picture="\z\havoc\addons\media\images\icon\shears_ca.paa";
    descriptionShort="";
    descriptionUse="";
};
class havoc_notes: havoc_booboo {
    scope = 2;
...
class havoc_triangleban: havoc_booboo {
    scope = 2;
    displayName="NAR Triangle Bandage";
    picture="\z\havoc\addons\media\images\icon\triangleban_ca.paa";
    descriptionShort="";
    descriptionUse="";
};
class havoc_NDC: havoc_booboo {
    scope = 2;
    ...
    picture="\z\havoc\addons\media\images\icon\NDC.paa";
};