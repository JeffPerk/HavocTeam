class CfgWeapons {
	...
	class HAVOC_FirstAid: ACE_ItemCore {
		...
		descriptionShort = "$STR_HAVOC_Item_Medical_FirstAid_Description";
	...
	class HAVOC_MedicKit: ACE_ItemCore {
		...
		descriptionShort = "$STR_HAVOC_Item_Medical_MedicKit_Description";
		editorPreview = "\havoc_medical\supplies\data\previews\medickit.jpg";
		picture = "\havoc_medical\supplies\data\ui\medickit_ca.paa";
