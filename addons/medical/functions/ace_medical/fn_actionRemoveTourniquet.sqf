...
[_patient, "activity", localize "STR_HAVOC_Medical_Activity_Tourniquet_Removed", [[_medic, false, true] call ACE_common_fnc_getName]] call ACE_medical_fnc_addToLog;
[_patient, "activity_view", localize "STR_HAVOC_Medical_Activity_Tourniquet_Removed", [[_medic, false, true] call ACE_common_fnc_getName]] call ACE_medical_fnc_addToLog;
