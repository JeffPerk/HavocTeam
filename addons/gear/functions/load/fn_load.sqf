...
[_unit] call havoc_gear_fnc_removeAll;

[_unit, _role, _type, _team] call havoc_gear_fnc_load_loadout;
[_unit, _role, _type, _team] call havoc_gear_fnc_load_properties;
