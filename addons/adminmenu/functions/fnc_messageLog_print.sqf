...
/* ----------------------------------------------------------------------------
Internal Function: HAVOC_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call HAVOC_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_HAVOC_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[HAVOC Adminmenu] Printed entry: %1%2",
