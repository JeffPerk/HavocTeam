...
_ctrlMap ctrlSetPosition [_ctrlGrpX, _ctrlGrpY, _ctrlGrpWidth, _ctrlGrpHeight - (2.2 * HAVOC_ADMINMENU_STD_HEIGHT)];
        ...
        [{
            ...
            if (_unit isKindOf "CAManBase") then { // humans
                if (_isParadropped) then {
                    ...
                    "[HAVOC Admin Menu] You were paradropped" remoteExec ["systemChat", _unit];
                } else {
                    _unit setVehiclePosition [_pos, [], 0, "FORM"];
                    "[HAVOC Admin Menu] You were teleported" remoteExec ["systemChat", _unit];
                };
            } else { // vehicles
                ...
                "[HAVOC Admin Menu] Your vehicle was teleported" remoteExec ["systemChat", _crew];
            };
        }, 0.1, [_pos, +GVAR(utilityData)]] call CBA_fnc_addPerFrameHandler;

        systemChat format ["[HAVOC Admin Menu] Teleported %1 players", _numPlayers];
...
_ctrlCheckDrawAllSides ctrlSetPosition [_ctrlGrpX, _ctrlGrpY + _ctrlGrpHeight - (2.2 * HAVOC_ADMINMENU_STD_HEIGHT), HAVOC_ADMINMENU_STD_WIDTH, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelDrawAllSides ctrlSetPosition [_ctrlGrpX + HAVOC_ADMINMENU_STD_WIDTH, _ctrlGrpY + _ctrlGrpHeight - (2.2 * HAVOC_ADMINMENU_STD_HEIGHT), (0.2 * _ctrlGrpWidth) - HAVOC_ADMINMENU_STD_WIDTH, HAVOC_ADMINMENU_STD_HEIGHT];
_ctrlLabelDrawAllSides ctrlCommit 0;
_ctrlLabelDrawAllSides ctrlSetText "Draw enemy units on map";

//private _paradropCheckX = (ctrlPosition _ctrlLabelDrawAllSides) select 0 + ctrlTextWidth _ctrlLabelDrawAllSides + HAVOC_ADMINMENU_STD_WIDTH;
...
_ctrlCheckParadropInfantry ctrlSetPosition [_ctrlGrpX + (0.2 * _ctrlGrpWidth), _ctrlGrpY + _ctrlGrpHeight - (2.2 * HAVOC_ADMINMENU_STD_HEIGHT), HAVOC_ADMINMENU_STD_WIDTH, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelParadropInfantry ctrlSetPosition [_ctrlGrpX + (0.2 * _ctrlGrpWidth) + HAVOC_ADMINMENU_STD_WIDTH, _ctrlGrpY + _ctrlGrpHeight - (2.2 * HAVOC_ADMINMENU_STD_HEIGHT), (0.2 * _ctrlGrpWidth) - HAVOC_ADMINMENU_STD_WIDTH, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlHint ctrlSetPosition [_ctrlGrpX, _ctrlGrpY + _ctrlGrpHeight - HAVOC_ADMINMENU_STD_HEIGHT, 0.8 * _ctrlGrpWidth, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlSetPosition [_ctrlGrpX + 0.8 * _ctrlGrpWidth, _ctrlGrpY + _ctrlGrpHeight - HAVOC_ADMINMENU_STD_HEIGHT, 0.2 * _ctrlGrpWidth, HAVOC_ADMINMENU_STD_HEIGHT];
