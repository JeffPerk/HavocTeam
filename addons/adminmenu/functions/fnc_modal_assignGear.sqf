...
_ctrlCheckFaction ctrlSetPosition [0, 0, HAVOC_ADMINMENU_STD_WIDTH, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelFaction ctrlSetPosition [HAVOC_ADMINMENU_STD_WIDTH, 0, (0.25 * _ctrlGrpWidth), HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlCheckFromMission ctrlSetPosition [(2 * HAVOC_ADMINMENU_STD_WIDTH) + (0.25 * _ctrlGrpWidth), 0, HAVOC_ADMINMENU_STD_WIDTH, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelFromMission ctrlSetPosition [(3 * HAVOC_ADMINMENU_STD_WIDTH) + (0.25 * _ctrlGrpWidth), 0, (0.6 * _ctrlGrpWidth), HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlComboFaction ctrlSetPosition [(0.1 * HAVOC_ADMINMENU_STD_WIDTH), (1.1 * HAVOC_ADMINMENU_STD_HEIGHT), _ctrlGrpWidth - (0.2 * HAVOC_ADMINMENU_STD_WIDTH), HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelBracketNumbers ctrlSetPosition [0, (2.2 * HAVOC_ADMINMENU_STD_HEIGHT), _ctrlGrpWidth, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelRoles ctrlSetPosition [0, (4.2 * HAVOC_ADMINMENU_STD_HEIGHT), (0.25 * _ctrlGrpWidth), HAVOC_ADMINMENU_STD_HEIGHT];
_ctrlLabelRoles ctrlCommit 0;
_ctrlLabelRoles ctrlSetText "Change Roles";

private _ctrlGrpRolesWidth = _ctrlGrpWidth - (0.2 * HAVOC_ADMINMENU_STD_WIDTH);
private _ctrlGrpRoles = _display ctrlCreate ["RscControlsGroup", -1, _ctrlGroup];
GVAR(utilityTabControls) pushBack _ctrlGrpRoles;
_ctrlGrpRoles ctrlSetPosition [(0.1 * HAVOC_ADMINMENU_STD_WIDTH), (5.3 * HAVOC_ADMINMENU_STD_HEIGHT), _ctrlGrpRolesWidth, _ctrlGrpHeight - (6.4 * HAVOC_ADMINMENU_STD_HEIGHT)];
...
private _ctrlComboRoleW = (0.5 * _ctrlGrpRolesWidth) - HAVOC_ADMINMENU_STD_WIDTH;
private _ctrlCheckChangeX = _ctrlGrpRolesWidth - HAVOC_ADMINMENU_STD_WIDTH;
{
    private _ctrlLineY = _forEachIndex * (1.1 * HAVOC_ADMINMENU_STD_HEIGHT);
    ...
    _ctrlLabelPlayer ctrlSetPosition [0, _ctrlLineY, _ctrlLabelPlayerW, HAVOC_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlComboRole ctrlSetPosition [_ctrlComboRoleX, _ctrlLineY, _ctrlComboRoleW, HAVOC_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlCheckChange ctrlSetPosition [_ctrlCheckChangeX, _ctrlLineY, HAVOC_ADMINMENU_STD_WIDTH, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlSetPosition [_ctrlGrpWidth * 0.8, _ctrlGrpHeight - HAVOC_ADMINMENU_STD_HEIGHT, _ctrlGrpWidth * 0.2, HAVOC_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    systemChat format ["[HAVOC Admin Menu] Assigned gear to %1 players", count GVAR(utility_assigngear_rolectrls)];
}];
