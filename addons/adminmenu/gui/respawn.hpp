class Controls {
    ...
    class spectatorListBox: RscListBox {
        ...
        //rowHeight = 0.97 * HAVOC_ADMINMENU_STD_HEIGHT;
    ...
    // {
        ...
        // h = 0.055 * safezoneH;
        // action="['respawnMenuChangeRoleAction'] spawn havoc_respawn_fnc_handleRespawnUI";
    // };
    ...
    // {
        ...
        // w = 0.0567187 * safezoneW;
        // h = 0.055 * safezoneH;
        // action="['respawnMenuChangeRankAction'] spawn havoc_respawn_fnc_handleRespawnUI";
    // };
};
