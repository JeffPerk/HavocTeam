    ...
    class GVAR(PlateCarrierHeavy_Blackcmd): V_PlateCarrierGL_rgr {
        ...
        hiddenSelectionsTextures[] = {QPATHTOF(data\vest_PlateCarrierHeavy_black_co_cmd.paa)};
        class ItemInfo: ItemInfo {
            hiddenSelections[] = {"camo"};
            containerClass = "Supply180";
            mass = 60;
    ...
    class GVAR(PlateCarrierHeavy_Coyotecmd): V_PlateCarrierGL_rgr {
        ...
        hiddenSelectionsTextures[] = {QPATHTOF(data\vest_PlateCarrierHeavy_coyote_co_cmd.paa)};
        class ItemInfo: ItemInfo {
            hiddenSelections[]= {"camo"};
            containerClass = "Supply180";
            mass = 90;
class HitpointsProtectionInfo {
    ...
    class GVAR(PlateCarrierHeavy_Greencmd): V_PlateCarrierGL_rgr {
        ...
        hiddenSelectionsTextures[] = {QPATHTOF(data\vest_PlateCarrierHeavy_green_co_cmd.paa)};
        class ItemInfo: ItemInfo {
            hiddenSelections[]= {"camo"};
            containerClass = "Supply180";
            mass = 90;
class HitpointsProtectionInfo {
    ...
    class GVAR(PlateCarrier1_brncmd): V_PlateCarrier1_rgr {
        ...
        hiddenSelections[] = {"camo"};
        hiddenSelectionsTextures[] = {QPATHTOF(data\vest_brown_cmd.paa)};
        class ItemInfo: ItemInfo {
            hiddenSelections[]= {"camo"};
            containerClass = "Supply180";
            mass = 60;
