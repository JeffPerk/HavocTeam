class HAVOC_ModulePortableFOB_Camp: Module_F
{
	scope = 2;
...
class HAVOC_ModulePortableFOB_Small: Module_F
{
	scope = 2;
...
class HAVOC_ModulePortableFOB_Medium: Module_F
{
	scope = 2;
...
class HAVOC_ModulePortableFOB_Large: Module_F
{
	scope = 2;
