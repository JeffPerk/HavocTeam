...
/*
Function: HAVOC_fnc_createPortableFOB
...
switch (_type) do {
	case "ANY_CAMP": {
		_type = selectRandom _HAVOC_FOBS_CAMPS;
		_name = _type select 1;
		_type = _type select 0;
	};
	case "ANY_SMALL": {
		_type = selectRandom _HAVOC_FOBS_SMALL;
		_name = _type select 1;
		_type = _type select 0;
	};
	case "ANY_MEDIUM": {
		_type = selectRandom _HAVOC_FOBS_MEDIUM;
		_name = _type select 1;
		_type = _type select 0;
	};
	case "ANY_LARGE": {
		_type = selectRandom _HAVOC_FOBS_LARGE;
		_name = _type select 1;
		_type = _type select 0;
	};
	default {
		switch (_size) do {
			case 0: {
				_name = [_HAVOC_FOBS_CAMPS, _type, "Camp"] call HAVOC_fnc_findInArrayMap;
			};
			case 1: {
				_name = [_HAVOC_FOBS_SMALL, _type, "Small FOB"] call HAVOC_fnc_findInArrayMap;
			};
			case 2: {
				_name = [_HAVOC_FOBS_MEDIUM, _type, "Medium FOB"] call HAVOC_fnc_findInArrayMap;
			};
			case 3: {
				_name = [_HAVOC_FOBS_LARGE, _type, "Large FOB"] call HAVOC_fnc_findInArrayMap;
			};
			default {};
		};
	};
...
[
	...
	"",
	"[_target] call HAVOC_fnc_checkFOBDeploy",
	"true",
	{hint "Deploying FOB!";},
	{},
	{hint "FOB deployed!"; [(_this select 0), (_this select 1)] call HAVOC_fnc_deployFOB;},
...
[
	...
	"",
	"[_target] call HAVOC_fnc_checkFOBPackUp",
	"true",
	{hint "Packing up FOB!";},
	{},
	{hint "FOB packed up!"; [(_this select 0), (_this select 1)] call HAVOC_fnc_packUpFOB;},
