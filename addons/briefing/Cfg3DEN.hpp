...
class cfgScriptPaths {
    HAVOC_briefing = "z\havoc\addons\briefing\ui_scripts\"; //" - Escape for VS code linter
};

class Cfg3DEN {
    class Mission {
        class HAVOC_MissionBriefingAttributes {
            displayName = "HAVOC Briefing settings"; // Text visible in the window title as "Edit <displayName>"
            ...
            class AttributeCategories {
                class HAVOC_BriefingSettings {
                    displayName = "HAVOC: Briefing settings"; // Category name visible in Edit Attributes window
                    collapsed = 0; // When 1, the category is collapsed by default
                    class Attributes {
                        class HAVOC_Briefing_Loadout {
                            property = "havoc_Briefing_Loadout";
                            ...
                            control = "Checkbox";
                            //expression = "missionNamespace setVariable ['HAVOC_Briefing_Loadout',_value];";
                            defaultValue = "false";
                            condition = "1";
                        };
                        class HAVOC_Briefing {
                            property = "havoc_Briefing";
                            displayName = "";
                            control = "BriefingSettings";
                            //expression = "missionNamespace setVariable ['HAVOC_BriefingArray',_value];";
    ...
    class Group {
        ...
        class AttributeCategories {
            ...
            class TeamworkMarker {
                class Attributes {
                    class HAVOC_Briefinglist {
                        displayName = ""; // Name assigned to UI control class Title
                        tooltip = ""; // Tooltip assigned to UI control class Title
                        property = "havoc_Briefinglist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression =  "[_this,'HAVOC_Briefinglist',_value] call havoc_common_fnc_initGroupVar;";// "_this setVariable ['HAVOC_Briefinglist',_value],true;";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
                    };
                };
            ...
            class TeamworkMarker {
                class Attributes {
                    class HAVOC_Briefinglist {
                        ...
                        property = "havoc_Briefinglist"; // Unique config property name saved in SQM
                        control = "None"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
                        expression = "_this setVariable ['HAVOC_Briefinglist',_value,true];";
                        defaultValue = "[]";
                        wikiType = "[[String]]";
    ...
    class Attributes {
        ...
        class BriefingSettings: Toolbox {
            ...
            scriptPath = "havoc_briefing";
            onLoad = "['onLoad',_this,'BriefingSettings','HAVOC_briefing',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');"; // 3rd param is the path PATH\scriptName.sqf
            onUnload = "['onUnload',_this,'BriefingSettings','HAVOC_briefing',false] call (uinamespace getvariable 'BIS_fnc_initDisplay');";
