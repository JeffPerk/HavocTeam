...
def main():
    ...
    print("""
  ######################################
  # havoc Development Environment Setup #
  ######################################

  This script will create your havoc dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your havoc project folder:
    [Arma 3 installation directory]\\{} => havoc project folder
    P:\\{}                              => havoc project folder
